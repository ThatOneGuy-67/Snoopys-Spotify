...
const playlistCatalog = [
    {
        ...
        songs: [
            ...
            { title: "D Animal", artist: "TopOppGen", file: "D Animal.mp3" },
            { title: "Beat It", artist: "TopOppGen", file: "Beat It.mp3" },
            { title: "drop dead", artist: "TopOppGen", file: "drop dead.mp3" },
            { title: "Jamaican (Bam Bam)", artist: "TopOppGen", file: "Jamaican (Bam Bam).mp3" },
            { title: "No Scrubs", artist: "TopOppGen", file: "No Scrubs.mp3" },
            { title: "Raindance (feat. Tems)", artist: "TopOppGen", file: "Raindance (feat. Tems).mp3" },
            { title: "Riptide", artist: "TopOppGen", file: "Riptide.mp3" },
            { title: "Risk It All", artist: "TopOppGen", file: "Risk It All.mp3" },
            { title: "SaWaDiKa", artist: "TopOppGen", file: "SaWaDiKa.mp3" },
            { title: "Teh Hijau", artist: "TopOppGen", file: "Teh Hijau.mp3" },
            { title: "The Fate of Ophelia", artist: "TopOppGen", file: "The Fate of Ophelia.mp3" },
            { title: "BIRDS OF A FEATHER", artist: "TopOppGen", file: "BIRDS OF A FEATHER.mp3" },
            { title: "Creep", artist: "TopOppGen", file: "Creep.mp3" },
            { title: "Great Expectation", artist: "TopOppGen", file: "Great Expectation.mp3" },
            { title: "Mr. Brightside", artist: "TopOppGen", file: "Mr. Brightside.mp3" },
            { title: "Sign of the Times", artist: "TopOppGen", file: "Sign of the Times.mp3" },
            { title: "Sunflower - Spider-Man_ Into the Spider-Verse", artist: "TopOppGen", file: "Sunflower - Spider-Man_ Into the Spider-Verse.mp3" },
            { title: "Yellow", artist: "TopOppGen", file: "Yellow.mp3" },
            { title: "Babydoll", artist: "TopOppGen", file: "Babydoll.mp3" },
            { title: "Billie Jean", artist: "TopOppGen", file: "Billie Jean.mp3" },
            { title: "Choosin' Texas", artist: "TopOppGen", file: "Choosin' Texas.mp3" },
            { title: "Cinderella (feat. Ty Dolla Sign)", artist: "TopOppGen", file: "Cinderella (feat. Ty Dolla Sign).mp3" },
            { title: "Dai Dai", artist: "TopOppGen", file: "Dai Dai.mp3" },
            { title: "Die With A Smile", artist: "TopOppGen", file: "Die With A Smile.mp3" },
            { title: "End of Beginning", artist: "TopOppGen", file: "End of Beginning.mp3" },
            { title: "Every Breath You Take", artist: "TopOppGen", file: "Every Breath You Take.mp3" },
            { title: "hate that i made you love me", artist: "TopOppGen", file: "hate that i made you love me.mp3" },
            { title: "Iris", artist: "TopOppGen", file: "Iris.mp3" },
            { title: "Locked out of Heaven", artist: "TopOppGen", file: "Locked out of Heaven.mp3" },
            { title: "Man I Need", artist: "TopOppGen", file: "Man I Need.mp3" },
            { title: "Ordinary", artist: "TopOppGen", file: "Ordinary.mp3" },
            { title: "Sailor Song", artist: "TopOppGen", file: "Sailor Song.mp3" },
            { title: "Self Aware", artist: "TopOppGen", file: "Self Aware.mp3" },
            { title: "stupid song", artist: "TopOppGen", file: "stupid song.mp3" },
            { title: "Sweater Weather", artist: "TopOppGen", file: "Sweater Weather.mp3" },
            { title: "SWIM", artist: "TopOppGen", file: "SWIM.mp3" },
            { title: "Training Season", artist: "TopOppGen", file: "Training Season.mp3" },
            { title: "Treat You Better", artist: "TopOppGen", file: "Treat You Better.mp3" },
            { title: "Wonderwall - Remastered", artist: "TopOppGen", file: "Wonderwall - Remastered.mp3" },
            { title: "back to friends", artist: "TopOppGen", file: "back to friends.mp3" },
            { title: "BbY WOW", artist: "TopOppGen", file: "BbY WOW.mp3" },
            { title: "Beauty And A Beat", artist: "TopOppGen", file: "Beauty And A Beat.mp3" },
            { title: "Earrings", artist: "TopOppGen", file: "Earrings.mp3" },
            { title: "Loser", artist: "TopOppGen", file: "Loser.mp3" },
            { title: "Love Me Not", artist: "TopOppGen", file: "Love Me Not.mp3" },
            { title: "the cure", artist: "TopOppGen", file: "the cure.mp3" },
            { title: "The One That Got Away", artist: "TopOppGen", file: "The One That Got Away.mp3" },
        ]
    },
    {
        id: "tupac",
